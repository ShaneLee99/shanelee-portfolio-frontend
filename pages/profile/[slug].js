      ...
      <div id="portfolio" className="mt-20 flex flex-col items-center px-20">
        ...
        <div className="w-full h-full gap-8 items-start flex flex-wrap transition-all justify-center mt-10 lg:max-w-[70%]">
            {Portfolios.map((portfolio) => (
                <a href={`/artwork/${portfolio.slug.current}`} className="w-auto md:w-[49%] lg:w-[24%] hover:scale-[0.95] h-full transition-all relative group rounded-xl flex flex-col items-center justify-center overflow-hidden">             
