      ...
      <div className="py-20 flex flex-col items-center px-10 md:px-[4rem] lg:px-40">
        ...
        <div className="mt-8 flex flex-col items-center">
          <div className="w-full h-full gap-8 items-start flex flex-wrap justify-center mt-[2rem]">
            ...
            {thumbnail?
              <div className="flex flex-col hover:scale-[0.95] transition-all items-center justify-center space-y-2 w-full md:w-[70%] lg:w-[45%] h-auto">
            ...
            {images?.map(( data ) => (
              <div className="flex flex-col hover:scale-[0.95] transition-all items-center space-y-2 w-full md:w-[70%] lg:w-[50%] h-auto">
